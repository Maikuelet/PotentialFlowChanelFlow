...
[stream,p,T,rho,v] = InitializeField(p0, T0, istream,rho0, nodeX,nodeY,v0);
...
%% SOLVER
% - GS Based Solver
[stream,p,T,rho,v] = GSsolver(stream,coeff,nodeX,nodeY,sigma,meshSizes,p,T,rho,T0,p0,v0,fluidC,v);
